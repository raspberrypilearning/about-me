...
+ Ανοίξτε το κενό μπιχλιμπίδι πρότυπου Python: <a href="http://jumpto.cc/python-new" target="_blank">jumpto.cc/python-new</a>.
...
+ Κάντε κλικ στο **Run**, και θα δείτε ότι το `print ()` η εντολή εκτυπώνει τα πάντα ανάμεσα στα εισαγωγικά `«»`.
...
+ Προσθέστε ξανά την προσφορά ή το βραχίονα και κάντε κλικ στο **Εκτέλεση** για να βεβαιωθείτε ότι το έργο σας λειτουργεί ξανά.
